...
<section class="services">
  <div class="services__container">
    ...
    <a href="/pantalla/donde-comer-en-tenjo/" class="services__card" data-aos="fade-down">
      <div class="services__image-wrapper">
        ...
        <div class="services__icon-badge">
          <img src="/wp-content/uploads/2025/11/cuchillo_tenedor.png" alt="Icono Comer" class="services__icon" />
        </div>
      </div>
    ...
    <a href="/pantalla/donde-dormir-en-tenjo/" class="services__card" data-aos="fade-down">
      <div class="services__image-wrapper">
        ...
        <div class="services__icon-badge">
          <img src="/wp-content/uploads/2025/11/cama.png" alt="Icono Dormir" class="services__icon" />
        </div>
      </div>
      <div class="services__content">
        <h3 class="services__title">
    ...
    <a href="/agenda-de-eventos/" class="services__card" data-aos="fade-down">
      <div class="services__image-wrapper">
        ...
        <div class="services__icon-badge">
          <img src="/wp-content/uploads/2025/11/agenda.png" alt="Icono Calendario" class="services__icon" />
        </div>
      </div>
      <div class="services__content">
        <h3 class="services__title">
  ...
  <div class="banco-imagenes" >
    <a href="/banco-de-imagenes/" class="banco-imagenes__header" data-aos="fade-down" aria-label="Ir al banco de imágenes">
