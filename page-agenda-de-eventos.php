...
if ($events_query->have_posts()):
  ...
  <section class="filtros-eventos">
    <div class="filtros-eventos__container">
      <!-- Buscar -->
      <div class="filtros-eventos__group" data-aos="fade-down">
        <label for="buscar" class="filtros-eventos__label">Buscar</label>
        <input type="text" id="buscar" class="filtros-eventos__input" placeholder="Buscar eventos..." />
      </div>

      <!-- Categoría del evento -->
      <div class="filtros-eventos__group" data-aos="fade-down">
        <label for="categoria" class="filtros-eventos__label">Categoría del evento</label>
      ...
      <div class="filtros-eventos__group" data-aos="fade-down">
        <label for="fecha-desde" class="filtros-eventos__label">Seleccionar fecha desde</label>
        <input type="date" id="fecha-desde" class="filtros-eventos__input filtros-eventos__input--date" />
      </div>

      <!-- Seleccionar fecha hasta -->
      <div class="filtros-eventos__group" data-aos="fade-down">
        <label for="fecha-hasta" class="filtros-eventos__label">Seleccionar fecha hasta</label>
        <input type="date" id="fecha-hasta" class="filtros-eventos__input filtros-eventos__input--date" />
      </div>
    </div>
  </section>
    ...
    <div class="agenda-eventos__container">
      ...
      <div class="agenda-eventos__row">
        ...
        <?php while ($events_query->have_posts()):
          ...
          <div class="evento-card" data-fecha="<?= esc_attr($fecha); ?>" data-titulo="<?= esc_attr(strtolower($title)); ?>"
            data-tipo="<?= esc_attr(strtolower($tipo)); ?>" data-aos="flip-down">
            ...
            <div class="evento-card__content">
              ...
              <?php if ($hora): ?>
                <div class="evento-card__time">
                  <img src="https://visitatenjo.com/wp-content/uploads/2025/11/reloj.png" alt="Hora"
                    class="evento-card__time-icon" />
